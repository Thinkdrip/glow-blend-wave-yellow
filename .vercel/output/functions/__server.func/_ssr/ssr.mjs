...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dos_EgDN.mjs");
...
var manifest = {
	"24c0a08176a7528040c09f15db1d5e7ba334d27610b08a22b412bf72ba7d49fe": {
		functionName: "submitSurvey_createServerFn_handler",
		importer: () => import("./survey-server-B53s6uq7.mjs")
	},
	"50887c27cb6d96f129d0c66affb41a2b56f6018a969745bf993cf6a5db0ab634": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DkJ1UNRI.mjs").then((n) => n.t),
